...
if __name__ == "__main__":
    ...
    workers.RunGrid(norbits=100000, nvel=4, vertices=V, dt=0.1, m=1.0, q=1.0, T=1.0, B0=1.0, scale=1.0, 
    ...
    #with h5py.File("C:/Users/Student/Desktop/Particle_Orbits/Orbits/data/WHAMTest/Test_1_r637_z-945_confined.h5") as ff:
    #    vels = ff.keys()
    #    print(vels)
    #    for v in vels:
    #        print(ff[v]['r'][:,2])
    ...
    #workers.plot_z_vs_t("C:/Users/Student/Desktop/Particle_Orbits/Orbits/data/WHAMTest/Test_1_r637_z-945_confined.h5")

    #workers.plot_trajectory("C:/Users/Student/Desktop/Particle_Orbits/Orbits/data/WHAMTest/Test_1_r637_z-945_confined.h5")
